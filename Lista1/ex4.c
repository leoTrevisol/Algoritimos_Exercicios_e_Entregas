/*
 * Programa: ex4(aplicador de teste).c
 ...
 * - prevencao de ultrapassagem de caracteres;
 * 
...
int main()
{
    ...
    printf("PARTE 1: Elebore o teste a ser aplicado.\nO teste de ser de multipla escolha(de 'a' ate 'e') e com no maximo 255 caracteres,inlcuindo as alternativas.\n");
    ...
    // digita o gabarito para cada questao//
